...
const styles = {
  label: 'block text-info-700 text-sm font-bold pt-2 pb-1',
  field:
    'bg-info-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none',
  button:
...
export const MemberPage = ({ brand, logoUrl }) => {
  ...
  return (
    <div className='flex flex-row w-full bg-danger'>
